<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/logo.png') }}" alt="Cotizador Hubbell" class="block h-10 w-auto fill-current text-gray-600">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('quotings.index')" :active="request()->routeIs('quotings.index')">
                        {{ __('Quotings') }}
                    </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div>{{ __('No. Cliente') }}: {{ Auth::user()->profile->client_number }} - {{ Auth::user()->name }}</div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('quotings.index')" :active="request()->routeIs('quotings.index')">
                {{ __('Quotings') }}
            </x-responsive-nav-link>
